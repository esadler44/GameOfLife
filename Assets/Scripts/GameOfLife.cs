...
class GameOfLife : MonoBehaviour {
    ...
    private const float MIN_TICK_INTERVAL = 0.5f;
    ...
    private void Start() {
        ...
        CreateCell(new Vector2Int(51, 50));
        CreateCell(new Vector2Int(52, 50));
        CreateCell(new Vector2Int(51, 51));
    }
